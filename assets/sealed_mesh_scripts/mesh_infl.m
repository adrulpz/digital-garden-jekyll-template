...
lengthX = 10;
widthY = 40;
nPerEdge = 100;      % border resolution
seamOffset = 2;    % fused region thickness from border
nDiamondInside = 100; % points inside each diamond
...
seamWidth = 1.0;    % how far inward the frame goes
density = 10;       % points per unit length (higher = denser)
...
diamond_density = 10; % points per unit, increase for denser grid
